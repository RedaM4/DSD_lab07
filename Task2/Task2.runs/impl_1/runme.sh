...
HD_PWD='/home/it/chipxprt/DSD/DSD_lab07/Task2/Task2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Task2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Task2.tcl -notrace
